...
public class NecroEntityEnderman extends NecroEntityBiped {
	...
	public void setAttributes(EntityLivingBase minion, BodyPartLocation location) {
		if(location == BodyPartLocation.Head) {
			head[0].attributes.func_111150_b(SharedMonsterAttributes.maxHealth).setAttribute(4.0D); //health
			...
			torso[0].attributes.func_111150_b(SharedMonsterAttributes.maxHealth).setAttribute(24.0D); //health
			...
			armLeft[0].attributes.func_111150_b(SharedMonsterAttributes.maxHealth).setAttribute(4.0D); //health
			...
			armLeft[0].attributes.func_111150_b(SharedMonsterAttributes.attackDamage).setAttribute(3.5D); //damage
		} else if(location == BodyPartLocation.ArmRight) {
			armRight[0].attributes.func_111150_b(SharedMonsterAttributes.maxHealth).setAttribute(4.0D); //health
			...
			armRight[0].attributes.func_111150_b(SharedMonsterAttributes.attackDamage).setAttribute(3.5D); //damage
		} else if(location == BodyPartLocation.Legs) {
			legs[0].attributes.func_111150_b(SharedMonsterAttributes.maxHealth).setAttribute(4.0D); //health
			...
			legs[0].attributes.func_111150_b(SharedMonsterAttributes.movementSpeed).setAttribute(0.3D); //speed
