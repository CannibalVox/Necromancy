...
public class NecroEntityWitch extends NecroEntityVillager {
	...
	public void setAttributes(EntityLivingBase minion, BodyPartLocation location) {
		if(location == BodyPartLocation.Head) {
			...
			armLeft[0].attributes.func_111150_b(SharedMonsterAttributes.maxHealth).setAttribute(3.0D); //health
			...
			armRight[0].attributes.func_111150_b(SharedMonsterAttributes.maxHealth).setAttribute(3.0D); //health
