...
public class NecroEntityCow extends NecroEntityQuadruped {
	...
	public void setAttributes(EntityLivingBase minion, BodyPartLocation location) {
		if(location == BodyPartLocation.Head) {
			...
			armLeft[0].attributes.func_111150_b(SharedMonsterAttributes.movementSpeed).setAttribute(0.175D); //speed
			...
			armRight[0].attributes.func_111150_b(SharedMonsterAttributes.movementSpeed).setAttribute(0.175D); //speed
			...
			legs[0].attributes.func_111150_b(SharedMonsterAttributes.movementSpeed).setAttribute(0.35D); //speed
