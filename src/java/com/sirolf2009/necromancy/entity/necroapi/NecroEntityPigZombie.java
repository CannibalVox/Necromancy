...
public class NecroEntityPigZombie extends NecroEntityBiped {
	...
	public void setAttributes(EntityLivingBase minion, BodyPartLocation location) {
		if(location == BodyPartLocation.Head) {
			...
			armLeft[0].attributes.func_111150_b(SharedMonsterAttributes.attackDamage).setAttribute(2.5D); //damage
			...
			armRight[0].attributes.func_111150_b(SharedMonsterAttributes.attackDamage).setAttribute(2.5D); //damage
			...
			legs[0].attributes.func_111150_b(SharedMonsterAttributes.movementSpeed).setAttribute(0.5D); //speed
