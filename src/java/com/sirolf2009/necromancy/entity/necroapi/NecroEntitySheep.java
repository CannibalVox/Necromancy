...
public class NecroEntitySheep extends NecroEntityQuadruped {
	...
	public void setAttributes(EntityLivingBase minion, BodyPartLocation location) {
		if(location == BodyPartLocation.Head) {
			...
			torso[0].attributes.func_111150_b(SharedMonsterAttributes.maxHealth).setAttribute(4.0D); //health
			...
			armLeft[0].attributes.func_111150_b(SharedMonsterAttributes.movementSpeed).setAttribute(0.0575D); //speed
			...
			armRight[0].attributes.func_111150_b(SharedMonsterAttributes.movementSpeed).setAttribute(0.0575D); //speed
			...
			legs[0].attributes.func_111150_b(SharedMonsterAttributes.movementSpeed).setAttribute(0.115D); //speed
