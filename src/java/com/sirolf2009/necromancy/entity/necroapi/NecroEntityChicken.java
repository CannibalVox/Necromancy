...
public class NecroEntityChicken extends NecroEntityBase {
	...
	public void setAttributes(EntityLivingBase minion, BodyPartLocation location) {
		if(location == BodyPartLocation.Head) {
			head[0].attributes.func_111150_b(SharedMonsterAttributes.maxHealth).setAttribute(0.5D); //health
			...
			torso[0].attributes.func_111150_b(SharedMonsterAttributes.maxHealth).setAttribute(2.0D); //health
			...
			armLeft[0].attributes.func_111150_b(SharedMonsterAttributes.maxHealth).setAttribute(0.5D); //health
			...
			armRight[0].attributes.func_111150_b(SharedMonsterAttributes.maxHealth).setAttribute(0.5D); //health
			...
			legs[0].attributes.func_111150_b(SharedMonsterAttributes.maxHealth).setAttribute(0.5D); //health
