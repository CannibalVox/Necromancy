...
public class ItemNecromancy {
    ...
    public static void initItems() {
        ...
        ThaumcraftApi.registerObjectTag(genericItems.itemID, 0, (new AspectList()).add(Aspect.DEATH, 2));
        ThaumcraftApi.registerObjectTag(genericItems.itemID, 1, (new AspectList()).add(Aspect.FLIGHT, 2).add(Aspect.LIFE, 4).add(Aspect.LIGHT, 2).add(Aspect.CRYSTAL, 2));
        ThaumcraftApi.registerObjectTag(genericItems.itemID, 2, (new AspectList()).add(Aspect.HEAL, 2).add(Aspect.LIFE, 4).add(Aspect.CRYSTAL, 2));
        ThaumcraftApi.registerObjectTag(genericItems.itemID, 3, (new AspectList()).add(Aspect.FLESH, 8).add(Aspect.MIND, 4));
        ...
        ThaumcraftApi.registerObjectTag(necronomicon.itemID, -1, (new AspectList()).add(Aspect.MIND, 666).add(Aspect.DEATH, 666).add(Aspect.DARKNESS, 666).add(Aspect.UNDEAD, 666).add(Aspect.UNDEAD, 666));
        ...
        ThaumcraftApi.registerObjectTag(scythe.itemID, -1, (new AspectList()).add(Aspect.WEAPON, 8).add(Aspect.LIFE, 2));
        ...
        ThaumcraftApi.registerObjectTag(scytheBone.itemID, -1, (new AspectList()).add(Aspect.WEAPON, 8).add(Aspect.DEATH, 2));
        ...
        ThaumcraftApi.registerObjectTag(scytheBone.itemID, -1, (new AspectList()).add(Aspect.METAL, 13).add(Aspect.HEAL, 16).add(Aspect.LIFE, 32));

        organs = new ItemOrgans(ConfigurationNecromancy.OrgansID).setUnlocalizedName("Organs");
        ThaumcraftApi.registerObjectTag(organs.itemID, 0, (new AspectList()).add(Aspect.FLESH, 8).add(Aspect.MIND, 4));
        ThaumcraftApi.registerObjectTag(organs.itemID, 1, (new AspectList()).add(Aspect.FLESH, 8));
        ThaumcraftApi.registerObjectTag(organs.itemID, 2, (new AspectList()).add(Aspect.FLESH, 2));
        ThaumcraftApi.registerObjectTag(organs.itemID, 3, (new AspectList()).add(Aspect.FLESH, 8));
        ThaumcraftApi.registerObjectTag(organs.itemID, 4, (new AspectList()).add(Aspect.UNDEAD, 2));
        ...
        ThaumcraftApi.registerObjectTag(organs.itemID, -1, (new AspectList()).add(Aspect.UNDEAD, 2).add(Aspect.BEAST, 2).add(Aspect.DEATH, 8));
